...
export const Themes = () => {
  return (
    ...
    >
      <div className='centered side-padding'>
        <div className="blue-bg section-box flex colored-cage side-padding vertical-padding position-rel overflow-hide">
        <div className="pattern bluish"></div>
          <div className='flex align-items flex-columns-rows'>
          <div className="coverpage__text-container even-flex zindex-1">
          ...
          <div className='flex align-items flex-columns-rows columns-reverse'>
            <div className="coverpage__image-container even-flex zindex-1">
              <div className="image">
                <img src={image_3} />
               </div>
            </div>
    ...
    <section className="section-page themes bridge-bg xl-vertical-padding overflow-hide">
    ...
    <section className="section-page themes xl-vertical-padding">
      <div className="centered side-padding">
      <div className=" section-box flex colored-cage dark-blue-bg side-padding vertical-padding">
          <div className='flex align-items flex-columns-rows'>
          <div className="coverpage__text-container even-flex">
