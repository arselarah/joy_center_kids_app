...
export const IndexPage = () => {
  ...
  return (
    <>
    <m.div className="hero main flex"
    initial={{opacity: 0}}
    animate={{opacity: 1}}
    ...
    >
        ...
        <div className="cloud object cloud-1" data-value="12"></div>
        <div className="cloud object cloud-2" data-value="4"></div>
        <div className="cloud object cloud-3" data-value="4"></div>
        <div className="cloud object cloud-4" data-value="12"></div>
    ...
    <m.section className='coverpage dark-blue-bg colored-cage overflow-hide'
    initial={{opacity: 0}}
    animate={{opacity: 1}}
    transition={{delay: .25, duration: .5, ease: 'linear' }}
    >
        ...
        <div className="pattern bluish"></div>
            <div className="coverpage__container flex align-items flex-columns-rows left-flex-xs gap-4 zindex-1 position-rel">
