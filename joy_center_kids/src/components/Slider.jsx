  ...
  return (
    ...
    <div className="overflow-hidden relative group">
        ...
        <div className='absolute inset-x-0 top-[50%] translate-y-[-50%] flex items-center justify-between p-4 duration-1000 max-h-16 align-middle'>
            <button onClick={prev} className='p-1 rounded-full shadow bg-white/80 hover:bg-white duration-500 hidden group-hover:block'>
            ...
            <button onClick={next} className='p-1 rounded-full shadow bg-white/80 hover:bg-white duration-500 hidden group-hover:block'>
